...
class AntColony(object):
    ...
    def solve(self):
        ...
        solution_history = {"iteration":[],"availability":[],"cost":[],"capacity":[],"solutions":[]}
        for i in tqdm(range(self.n_iterations)):
            ...
            if len(feasible_solutions)!=0:
                shortest_path = max(feasible_solutions, key=lambda x: x[1][0])
                print("iteration " + str(i) + " found " + str(len(feasible_solutions)) + " solution(s)")
                for solution in feasible_solutions:
                    solution_history["iteration"].append(i)
                    solution_history["availability"].append(solution[1][1])
                    solution_history["cost"].append(solution[1][2])
                    solution_history["capacity"].append(solution[1][3])
                    solution_history["solutions"].append(solution)
            else:
        ...
        return all_time_shortest_path, solution_history
